...
function App() {
  ...
  async function handleContactFormSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if  (! responseData)
    {
      console.log('Error sending email:', responseData.error);
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <Card className="space-y-6 scroll-m-12" id="contactez-nous">
                ...
                {!showContactFormSuccess && <form onSubmit={(e) => handleContactFormSubmit(e)} className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4 md:gap-y-6">
                  <div className="relative">
                    <input type="text" value={form.first_name} onChange={(e) => setForm((values) => ({...values, first_name: e.target.value }))} id="input-first-name" name="first_name" className="peer p-4 block w-full border-silver-chalice-400 rounded-lg sm:text-sm placeholder:text-transparent focus:border-astronaut-blue-900 focus:ring-astronaut-blue-900 disabled:opacity-50 disabled:pointer-events-none focus:pt-6 focus:pb-2 not-placeholder-shown:pt-6 not-placeholder-shown:pb-2 autofill:pt-6 autofill:pb-2" />
                  ...
                  <div className="relative">
                    <input type="text" value={form.last_name} onChange={(e) => setForm((values) => ({...values, last_name: e.target.value }))} id="input-last-name" name="last_name" className="peer p-4 block w-full border-silver-chalice-400 rounded-lg sm:text-sm placeholder:text-transparent focus:border-astronaut-blue-900 focus:ring-astronaut-blue-900 disabled:opacity-50 disabled:pointer-events-none focus:pt-6 focus:pb-2 not-placeholder-shown:pt-6 not-placeholder-shown:pb-2 autofill:pt-6 autofill:pb-2" />
                  ...
                  <div className="relative">
                    <input type="email" value={form.email} onChange={(e) => setForm((values) => ({...values, email: e.target.value }))} id="input-email" name="email" className="peer p-4 block w-full border-silver-chalice-400 rounded-lg sm:text-sm placeholder:text-transparent focus:border-astronaut-blue-900 focus:ring-astronaut-blue-900 disabled:opacity-50 disabled:pointer-events-none focus:pt-6 focus:pb-2 not-placeholder-shown:pt-6 not-placeholder-shown:pb-2 autofill:pt-6 autofill:pb-2" />
                  ...
                  <div className="relative">
                    <input type="text" value={form.organisation} onChange={(e) => setForm((values) => ({...values, organisation: e.target.value }))} id="input-organisation" name="organisation" className="peer p-4 block w-full border-silver-chalice-400 rounded-lg sm:text-sm placeholder:text-transparent focus:border-astronaut-blue-900 focus:ring-astronaut-blue-900 disabled:opacity-50 disabled:pointer-events-none focus:pt-6 focus:pb-2 not-placeholder-shown:pt-6 not-placeholder-shown:pb-2 autofill:pt-6 autofill:pb-2" />
                  ...
                  <textarea value={form.message} onChange={(e) => setForm((values) => ({...values, message: e.target.value }))} name="message" placeholder="Message" className="col-span-full py-1 sm:py-2 px-3 block w-full border-silver-chalice-400 rounded-lg sm:text-sm focus:border-astronaut-blue-900 focus:ring-astronaut-blue-900 disabled:opacity-50 disabled:pointer-events-none" rows={6}></textarea>
